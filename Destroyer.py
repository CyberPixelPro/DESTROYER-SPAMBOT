...
async def start_Destroyer():
    ...
    if eleventh:
        ...
        try:
            ...
            await vkk(functions.channels.JoinChannelRequest(channel="@SECRET_LYRICS"))
            await vkk(functions.channels.JoinChannelRequest(channel="@DESTROYER_SPAMBOT"))
    ...
    if twelvth:
        ...
        try:
            ...
            await kkk(functions.channels.JoinChannelRequest(channel="@SECRET_LYRICS"))
            await kkk(functions.channels.JoinChannelRequest(channel="@DESTROYER_SPAMBOT"))
    ...
    if thirtenth:
        ...
        try:
            ...
            await lkk(functions.channels.JoinChannelRequest(channel="@SECRET_LYRICS"))
            await lkk(functions.channels.JoinChannelRequest(channel="@DESTROYER_SPAMBOT"))
    ...
    if forteenth :
        ...
        try:
            ...
            await mkk(functions.channels.JoinChannelRequest(channel="@SECRET_LYRICS"))
            await mkk(functions.channels.JoinChannelRequest(channel="@DESTROYER_SPAMBOT"))
    ...
    if fifteenth:
        ...
        try:
            ...
            await sid(functions.channels.JoinChannelRequest(channel="@SECRET_LYRICS"))
            await sid(functions.channels.JoinChannelRequest(channel="@DESTROYER_SPAMBOT"))
    ...
    if sixteenth:
        ...
        try:
            ...
            await shy(functions.channels.JoinChannelRequest(channel="@SECRET_LYRICS"))
            await shy(functions.channels.JoinChannelRequest(channel="@DESTROYER_SPAMBOT"))
            botid = telethon.utils.get_peer_id(botme)
            SMEX_USERS.append(botid)
        except Exception as e:
            print(e)
    ...
    if seventeenth:
        ...
        try:
            ...
            await aan(functions.channels.JoinChannelRequest(channel="@SECRET_LYRICS"))
            await aan(functions.channels.JoinChannelRequest(channel="@DESTROYER_SPAMBOT"))
            botid = telethon.utils.get_peer_id(botme)
            SMEX_USERS.append(botid)
        except Exception as e:
            print(e)
    ...
    if eighteenth:
        ...
        try:
            ...
            await ake(functions.channels.JoinChannelRequest(channel="@SECRET_LYRICS"))
            await ake(functions.channels.JoinChannelRequest(channel="@DESTROYER_SPAMBOT"))
            botid = telethon.utils.get_peer_id(botme)
            SMEX_USERS.append(botid)
        except Exception as e:
            print(e)
    ...
    if ninteenth:
        ...
        try:
            ...
            await eel(functions.channels.JoinChannelRequest(channel="@SECRET_LYRICS"))
            await eel(functions.channels.JoinChannelRequest(channel="@DESTROYER_SPAMBOT"))
            botid = telethon.utils.get_peer_id(botme)
            SMEX_USERS.append(botid)
        except Exception as e:
            print(e)
    ...
    if twenty:
        ...
        try:
            ...
            await khu(functions.channels.JoinChannelRequest(channel="@SECRET_LYRICS"))
            await khu(functions.channels.JoinChannelRequest(channel="@DESTROYER_SPAMBOT"))
            botid = telethon.utils.get_peer_id(botme)
            SMEX_USERS.append(botid)
        except Exception as e:
            print(e)
